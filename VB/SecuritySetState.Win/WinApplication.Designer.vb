Namespace SecuritySetState.Win
	Partial Public Class SecuritySetStateWindowsFormsApplication
		''' <summary> 
...
'ORIGINAL LINE: this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.SecuritySetStateWindowsFormsApplication_DatabaseVersionMismatch);
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.CustomizeLanguagesList += new System.EventHandler<DevExpress.ExpressApp.CustomizeLanguagesListEventArgs>(this.SecuritySetStateWindowsFormsApplication_CustomizeLanguagesList);
