...
Imports SecuritySetState.Module.BusinessObjects
	...
	Public Class Updater
		...
		Public Overrides Sub UpdateDatabaseAfterUpdateSchema()
			...
			For i As Integer = 0 To 1
				...
				Dim contact As Contact = CreateObject(Of Contact)("FirstName", contactName)
				contact.LastName = "LastName" & i
				contact.Age = i * 10
				For j As Integer = 0 To 1
					Dim taskName As String = "Subject" & i & " - " & j
					Dim task = CreateObject(Of MyTask)("Subject", taskName)
		...
		Private Function CreateObject(Of T)(ByVal propertyName As String, ByVal value As String) As T
			...
			If theObject Is Nothing Then
				...
				DirectCast(DirectCast(theObject, Object), BaseObject).SetMemberValue(propertyName, value)
			End If
